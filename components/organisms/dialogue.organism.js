...
class DialogueOrganism extends ComponentSuperclass {
  constructor (props) { super(props, 'dialogueOrg') }
...
const DialogueOrganismConnected = connect(state => ({
  isSocketConnected: state.ui.isSocketConnected,

}), null)(DialogueOrganism)

module.exports = DialogueOrganismConnected